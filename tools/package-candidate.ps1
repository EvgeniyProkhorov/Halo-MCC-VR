...
try {
    ...
    $manifest = [ordered]@{
        ...
        reach_passenger_personal_weapon_presentation_enabled = $true
        reach_passenger_personal_weapon_presentation_scope =
            'render-scoped-allows-weapons-seat-only'
        reach_vehicle_trim_fine_step_m = 0.001
