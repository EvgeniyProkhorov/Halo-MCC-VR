...
$manifestContracts = @(
    ...
    'reach_passenger_personal_weapon_presentation_enabled\s*=\s*\$true',
    'render-scoped-allows-weapons-seat-only',
    'reach_vehicle_trim_fine_step_m\s*=\s*0\.001',
...
$installerContracts = @(
    ...
    'reach_passenger_personal_weapon_presentation_enabled\s*-ne',
    'render-scoped-allows-weapons-seat-only',
    'reach_vehicle_trim_fine_step_m\s*-ne\s*0\.001',
    'hrek-checksum-count-exact-tag-next-pair',
